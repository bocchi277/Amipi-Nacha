...
const HistoryScreen = (() => {
  ...
  function handleExportCSV() {
    ...
    const headers = ['ID', 'Effective Date', 'Vendor Name', 'Recipient Email', 'Amount ($)', 'Invoice Reference', 'Sequence ID', 'Status', 'Sent At'];
  ...
  function handleExportExcel() {
    ...
    const headers = ['#', 'Effective Date', 'Vendor Name', 'Recipient Email', 'Amount ($)', 'Invoice Reference', 'Sequence ID', 'Generated By', 'Status', 'Sent At'];
  ...
  function renderTable() {
    ...
    pageItems.forEach((r, i) => {
      ...
      tr.innerHTML = `
        ...
        <td class="font-mono text-xs" style="white-space: nowrap;">${r.sequence_id ? `<span class="badge" style="background: #F8FAFC; border: 1px solid #CBD5E1; color: #1E293B; font-size: 11px; padding: 2px 6px; font-family: monospace; letter-spacing: 0.5px;">${r.sequence_id}</span>` : '<span class="text-muted">—</span>'}</td>
